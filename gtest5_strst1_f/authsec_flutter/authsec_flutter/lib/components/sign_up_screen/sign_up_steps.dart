...
import 'package:authsec_flutter/components/sign_up_screen/step_get_bank_account.dart';
import 'package:authsec_flutter/components/sign_up_screen/step_get_email_password.dart';
import 'package:authsec_flutter/components/sign_up_screen/step_get_name_address.dart';
import 'package:authsec_flutter/screens/login_screen.dart';
import 'package:authsec_flutter/utilities/hadwin_markdown_viewer.dart';

import 'package:authsec_flutter/utilities/make_api_request.dart';
import 'package:authsec_flutter/utilities/display_error_alert.dart';
import 'package:authsec_flutter/utilities/slide_right_route.dart';
...
//? FUNCTION TO CHECK FOR ERRORS IN ANY STEPS PRIOR FROM THE ONE REQUESTED
        ...
        switch (i) {
          ...
          case 1:
            ...
            if (stepCompletedSuccessfully[1]) {
              ...
              // emailPasswordFormKey.currentState?.validate();
              if (signUpDetails["new_password"]!.isEmpty ||
                  signUpDetails["confirm_password"]!.isEmpty) {
                errorStatus = true;
              }
            } else {
              errorStatus = true;
  ...
  void _tryRegistering() {
    sendData(urlPath: '/token/addOneAppUser', data: signUpDetails)
        .then((response) {
