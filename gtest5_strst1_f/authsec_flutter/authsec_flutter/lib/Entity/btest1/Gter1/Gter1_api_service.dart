...
class ApiService {
  ...
  final Dio dio = Dio();
   ...
   Future<List<Map<String, dynamic>>> getEntities(String token) async {
    ...
    try {
      ...
      final response = await dio.get('$baseUrl/Gter1/Gter1');
 ...
 Future<void> createEntity(String token, Map<String, dynamic> entity) async {
    try {
      ...
      dio.options.headers['Authorization'] = 'Bearer $token';
      await dio.post('$baseUrl/Gter1/Gter1', data: entity);
      print(entity);
    } catch (e) {
  ...
  Future<void> updateEntity(String token, int entityId, Map<String, dynamic> entity) async {
    try {
      dio.options.headers['Authorization'] = 'Bearer $token';
      await dio.put('$baseUrl/Gter1/Gter1/$entityId',
  ...
  Future<void> deleteEntity(String token, int entityId) async {
    try {
      dio.options.headers['Authorization'] = 'Bearer $token';
      await dio.delete('$baseUrl/Gter1/Gter1/$entityId');
    } catch (e) {
